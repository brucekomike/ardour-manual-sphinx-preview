...
Pick a clip in the library, play it to see if that\'s what you need,
then drag it towards the matrix view and drop to any slot. Please note
that dropping a clip onto a slot that already has a clip will replace
that clip with the new one.

If you added a clip to a trigger slot by bouncing a region or a range
directly to a scene and you like how it sounds, you might want to add
