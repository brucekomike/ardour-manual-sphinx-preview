...
[ /path/of/command type parameter ]{.kbd}
...
just doesn\'t make sense. For example, a parameter that is specified as
a Float with a range of 0 to 1, could be sent as an Integer, but would
