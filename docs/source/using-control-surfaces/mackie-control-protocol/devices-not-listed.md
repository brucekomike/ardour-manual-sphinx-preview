...
Function key Editor uses these button names. The \"Mackie Control\"
option should be considered default and should be tried with any
unlisted device before attempting to create a custom definition file.
