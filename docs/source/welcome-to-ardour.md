...
### Audio and MIDI Multi-Track Recording and Editing {#multitrack-recording}
...
### Plugins with Full Sample Accurate Automation {#plugins}
...
### Transport Sync and External Control Surfaces {#transport-and-control-surfaces}
...
### Powerful Anywhere-to-Anywhere Signal Routing {#signal-routing}
